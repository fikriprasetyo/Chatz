...
import Fikri.app.chatz.Fragments.ChatsFragment;
import Fikri.app.chatz.Fragments.ProfileFragment;
import Fikri.app.chatz.Fragments.UsersFragment;
import Fikri.app.chatz.Model.Chat;
...
public class MainActivity extends AppCompatActivity implements OnItemClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MRR = Typeface.createFromAsset(getAssets(), "fonts/Poppins-Regular.ttf");
        MR = Typeface.createFromAsset(getAssets(), "fonts/Poppins-Regular.ttf");
