package Fikri.app.chatz.Adapter;
...
import Fikri.app.chatz.MessageActivity;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {
    ...
    public UserAdapter(Context mContext, OnItemClick onItemClick, List<User> mUsers, boolean ischat){
        ...
        if(mContext!=null) {
            MRR = Typeface.createFromAsset(mContext.getAssets(), "fonts/Poppins-Regular.ttf");
            MR = Typeface.createFromAsset(mContext.getAssets(), "fonts/Poppins-SemiBold.ttf");
        }
